...
cat > "$OUTPUT" << HEADER
! Title: Ahmed's Ultimate Filter List
! Description: Comprehensive ad, tracker, malware, phishing & annoyance protection
! Last updated: ${timestamp}
! Expires: 1 day
! Homepage: https://github.com/ahmedok2022/MyOwnFilterList
! License: https://github.com/ahmedok2022/MyOwnFilterList/blob/main/LICENSE
...
!   4. Change: ublock-
!      To:     ublock- https://raw.githubusercontent.com/ahmedok2022/
